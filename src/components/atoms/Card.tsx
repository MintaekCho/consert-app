...
const Card = ({ type, canBook = false, data }: CardProps<CardType>) => {
  ...
  return (
    <>
      ...
      <article className="w-full max-w-[300px] p-1">
        <div className="w-full max-w-[300px] relative group rounded-xl flex flex-col items-center overflow-hidden bg-white p-2 m-2 hover:scale-105 duration-300 ease-in-out">
          <Link
